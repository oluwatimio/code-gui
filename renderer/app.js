...
// ===== Auto-mode panel =====
//
// Lives in renderer/auto-panel.js. We share script-scope with that file (both
// are classic <script> tags loaded in index.html), so:
//   - auto-panel.js reads from this file's globals (MODELS, EFFORTS, state,
//     escapeHtml, getCurrentConversation, createConversation, switchConversation,
//     saveState, inputEl, messagesEl, autoResize, scrollToBottom, generateUUID,
//     effectiveProjectPath).
//   - This file calls into auto-panel.js entry points: `wireAutoPanelEvents()`
//     and `refreshAutoPanel()`.
// Load order (set in index.html): auto-panel.js BEFORE app.js. Function
// references resolve at call time, so the const-hoisting order is fine.
